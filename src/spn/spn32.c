...
uint8_t inner_table[4][4] = {{0x02, 0x03, 0x01, 0x01},
                             {0x01, 0x02, 0x03, 0x01},
                             {0x01, 0x01, 0x02, 0x03},
                             {0x03, 0x01, 0x01, 0x01}};

uint32_t outer_table[4][4] = {{0x01,0x06,0x04,0x02},
                              {0x02,0x01,0x06,0x04},
                              {0x04,0x02,0x01,0x06},
                              {0x06,0x04,0x02,0x01}};

const uint8_t* inner_matrix[2][2] = {{TABLE(8, 02), TABLE(8, 03), TABLE(8, 01), TABLE(8, 01)},
...
void linear(uint32_t* input, uint32_t*  matrix[8][8])
{
    int i = 0, j;
    uint32_t tmp_value;
...
static void nonlinear(uint32_t* input, uint8_t* extended_key)
{
